...
The optional SpicyDocs integration and its source-reading, bill-acquisition and annual-CFR
...
the package pin and lock, and run the source-catalog, GovInfo bill/CFR and package
...
[bill example](../docs/govinfo-bill-example.md), and
[annual CFR example](../docs/govinfo-cfr-example.md).
