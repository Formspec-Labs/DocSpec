...
SpicyDocs 0.16.0 shares its ordered XML tree between MODS and PREMIS. The annual
...
XML/HTML source events and image-header observations now use that same core
