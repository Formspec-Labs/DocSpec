...
* ``current`` — :func:`docspec.ontology.citations.parse_authority_citation`,
...
from docspec.docpipeline.adapters import (  # noqa: E402, F401
    StructuredTextCallError,
    StructuredTextResult,
)
from docspec.ontology.citations import (  # noqa: E402
    canonical_frdoc_iri,
...
def canonical_json(value: object) -> str:
    """Serialize deterministically (origin: docspec/ontology/common.py:84)."""
...
def cfr_compact_key_only(text: str) -> bool:
    ...
    if not parse_cfr_citation(text):
        return False
    from docspec.ontology.citations import _CFR_STANDARD, _CFR_TITLE_PART  # noqa: PLC0415
...
def build_detection_artifact(
    *,
    ...
    receipt = {
        ...
        "arms": {
            "current": {
                "entry_point": "docspec.ontology.citations.parse_authority_citation",
            ...
            "current_extended": {
                "entry_points": [
                    "docspec.ontology.citations.parse_authority_citation",
                    "docspec.ontology.citations.parse_cfr_citation",
                    "docspec.ontology.citations.normalize_rin",
                    "docspec.ontology.citations.canonical_frdoc_iri",
                    "docspec.ontology.citations.normalize_docket_reference",
                ],
...
def command_adjudicate(args: argparse.Namespace) -> int:
    ...
    from docspec.docpipeline.adapters.openai_compatible import (  # noqa: PLC0415
