...
| Maintain the generated scale-profile schema | [generate_scale_profile_schema.py](generate_scale_profile_schema.py) | Follow the [schema guide](../docs/schema-maintenance.md) and use check mode before changing generated bytes. |
