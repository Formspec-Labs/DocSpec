...
_MODULE_METADATA: dict[str, tuple[str, str, tuple[str, ...]]] = {
    ...
    "src/docspec/adapters/wire_source_release.py": ("Digest-verified pinned wire schema set and Draft 2020-12 structural gate for an exchanged source release", "implemented", ("SOURCE-CATALOG-CONTRACT", "DOCUMENT-RELEASE-INTEGRITY")),
