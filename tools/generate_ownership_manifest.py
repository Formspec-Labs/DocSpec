...
_MODULE_METADATA: dict[str, tuple[str, str, tuple[str, ...]]] = {
    ...
    "src/docspec/adapters/source_catalog.py": ("Local immutable JSON Lines source catalogs, digest-pinned sealed release admission, release-backed planning input, and contained file fetching", "implemented", ("SOURCE-CATALOG-CONTRACT", "ACQUISITION")),
    "src/docspec/adapters/storage.py": ("Portable local blobs, control records, job revisions, record layers, and coherently verified release catalog", "implemented", ("BLOB-STORE-CONTRACT", "DOCUMENT-CATALOG-CONTRACT", "DOCUMENT-STORE", "DOCUMENT-RELEASE-INTEGRITY", "INCREMENTAL-EQUIVALENCE", "RECORD-STORAGE-CONTRACT", "RELEASE-MANIFEST")),
    "src/docspec/adapters/wire_source_release.py": ("Digest-verified pinned wire schema set, Draft 2020-12 structural gate, and bounded-memory reader for an exchanged source release", "implemented", ("SOURCE-CATALOG-CONTRACT", "DOCUMENT-RELEASE-INTEGRITY")),
    ...
    "src/docspec/domain/release.py": ("Canonical complete-current-state DocumentRelease root", "implemented", ("DOCUMENT-RELEASE-INTEGRITY", "INCREMENTAL-EQUIVALENCE", "RELEASE-MANIFEST")),
    ...
    "src/docspec/ports/source_release.py": ("Digest-pinned sealed source-release admission, source-item stream, and structural schema-gate boundary", "implemented", ("SOURCE-CATALOG-CONTRACT", "DOCUMENT-RELEASE-INTEGRITY")),
