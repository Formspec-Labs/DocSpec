...
_MODULE_METADATA: dict[str, tuple[str, str, tuple[str, ...]]] = {
    ...
    "src/docspec/adapters/source_catalog.py": ("Local immutable JSON Lines source catalogs, digest-pinned sealed release admission, and contained file fetching", "implemented", ("SOURCE-CATALOG-CONTRACT", "ACQUISITION")),
