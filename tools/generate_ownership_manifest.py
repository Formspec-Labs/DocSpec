...
_MODULE_METADATA: dict[str, tuple[str, str, tuple[str, ...]]] = {
    ...
    "src/docspec/ports/source_release.py": ("Digest-pinned sealed source-release admission and source-item stream boundary", "implemented", ("SOURCE-CATALOG-CONTRACT", "DOCUMENT-RELEASE-INTEGRITY")),
