...
from docspec.ontology.candidate_channels import BM25ConceptMapper, build_dense_concept_index
from docspec.ontology.common import read_parquet_rows, write_parquet_rows
...
def dense_mapper(registry_rows):
    from docspec.ontology.candidate_channels import DenseConceptMapper
...
def test_v1_configuration_uses_the_production_selector(harness, registry_rows, units_by_id):
    from docspec.ontology.concepts import select_candidate_concepts_for_text
