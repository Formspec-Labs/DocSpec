...
from docspec.docpipeline.adapters import docling as adapter_module
...
ADAPTER_PATH = SOURCE_ROOT / "docspec" / "docpipeline" / "adapters" / "docling.py"
ADAPTER_MODULE = "docspec.docpipeline.adapters.docling"
...
ALLOWED_ADAPTER_CONSUMERS = frozenset({"docspec.docpipeline.source"})
