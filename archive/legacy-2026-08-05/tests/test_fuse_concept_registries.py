...
* **id minting matches the repository idiom** — the ids this tool mints are the
  ids ``docspec.ontology`` would have minted, which is what makes the
...
from docspec.ontology.common import RunContext, canonical_json, read_parquet_rows, stable_id
from docspec.ontology.concepts import CONCEPT_COLUMNS, concept_aliases, normalize_label
