...
from docspec.ontology.act_index import (
    ALIAS_YEAR_RULE,
    UNRESOLVED_REASONS,
    ActIndex,
    ActResolution,
...
from docspec.ontology.citations import find_act_relative_citations, normalize_popular_name
...
def test_a_citation_that_cannot_resolve_says_which_way_it_failed(act, section, reason):
    from docspec.ontology.citations import ActRelativeCitation
