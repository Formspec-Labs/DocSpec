...
from docspec.source_profile_artifacts import (
...
def test_profile_declarations_import_without_pipeline_or_refspec() -> None:
    completed = subprocess.run(
        [
            ...
            "-c",
            (
                "import sys; import docspec.source_profile_artifacts; "
                "unexpected=[name for name in sys.modules if "
                "name.startswith(('docspec.docpipeline', 'docspec.ontology', 'refspec'))]; "
