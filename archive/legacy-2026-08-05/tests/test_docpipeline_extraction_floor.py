...
class TestTheGateIsWiredAtTheBoundary:
    ...
    def test_a_healthy_markup_parse_passes_the_boundary(self) -> None:
        from docspec.document_file_pipeline import _refuse_thin_markup_parse
    ...
    def test_each_pdf_parser_is_gated_under_its_own_floor(self) -> None:
        ...
        from docspec.document_file_pipeline import DocumentFilePipelineError, _refuse_thin_pdf_parse
    ...
    def test_xml_media_types_share_one_declared_floor(self) -> None:
        ...
        from docspec.docpipeline.source import retention_format_for
