...
from docspec.docpipeline.adapters.openai import TiktokenCounter
from docspec.docpipeline.segments import SegmentSettings, segment_artifact
from docspec.docpipeline.source import SourceRecord, build_source_artifact, profile_for_table
...
def test_git_commit_checks_the_implementation_repository(
    ...
    def fake_run(*args: Any, **kwargs: Any) -> SimpleNamespace:
        ...
        return SimpleNamespace(stdout=" M src/docspec/rulespec_testbed.py\n")

    monkeypatch.setattr("docspec.rulespec_testbed.subprocess.run", fake_run)
