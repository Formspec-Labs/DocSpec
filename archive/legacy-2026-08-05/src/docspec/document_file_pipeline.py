...
from docspec.adapters.spicyregs import DOCUMENT
from docspec.adapters.spicyregs import PAGE_SEPARATOR, PdfTextResult, PdfTextStatus, extract_pdf_text
...
def _prepare_source_cache_release(
    ...
    *,
    ...
    from docspec.corpora.segmentation_evaluation import FULL_DOCUMENT_SPECS, validate_source_cache
