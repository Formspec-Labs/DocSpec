...
from docspec.document_release_v3_diff import release_member_paths
from docspec.document_release_v3_verify import verify_release_or_raise
from docspec.document_release_v3_writer import BoundedParquetWriter, atomic_publish_directory
...
def _load_json(path: Path) -> dict[str, Any]:
    from docspec.document_release_v3 import parse_canonical_json
