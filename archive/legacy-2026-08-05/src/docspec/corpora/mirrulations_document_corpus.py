...
from docspec.corpora.body_retrieval_corpus import scan_for_secrets
from docspec.ontology.common import canonical_json
from docspec.adapters.spicyregs import DOCUMENT
from docspec.adapters.spicyregs import (
    BUCKET,
    PREFIX,
...
def write_v3_selection(
    ...
    *,
    ...
    digest = hashlib.sha256()
    size = 0
    from docspec.document_release_v3_writer import SourceInput
