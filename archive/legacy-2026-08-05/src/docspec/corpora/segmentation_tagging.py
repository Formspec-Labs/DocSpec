...
from docspec.ontology.invariants import assert_concept_graphs
...
from docspec.ontology.receipt import _valid_completed_model_call
from docspec.ontology.subjects import Artifact, SourceElement, Subject
