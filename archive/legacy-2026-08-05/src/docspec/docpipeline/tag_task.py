...
from docspec.docpipeline.segments import ProcessingSegment
from docspec.docpipeline.source import SourceArtifact
from docspec.ontology.common import canonical_json, stable_id
from docspec.ontology.concept_dimensions import (
    LOCAL_SOURCE_VOCABULARY,
    concept_facet,
    concept_source_vocabulary,
)
from docspec.ontology.concepts import concept_aliases, normalize_label
