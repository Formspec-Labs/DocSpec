...
``docspec.ontology.candidate_channels`` owns channel C and its exact search:
:class:`~docspec.ontology.candidate_channels.DenseConceptMapper` holds the
...
class UsearchConceptMapper:
    ...
    Drop-in for :class:`~docspec.ontology.candidate_channels.DenseConceptMapper`:
