...
* **Selector parity.** Candidates are produced by the *production* selector
  (``docspec.ontology.concepts.select_candidate_concepts_for_text``) at the
...
from docspec.ontology.common import canonical_json, read_parquet_rows
from docspec.ontology.concept_dimensions import concept_facet, concept_source_vocabulary
