...
from docspec.candidate_release import (  # noqa: E402
    CandidateReleaseError,
    VocabularyAtlasCandidateSource,
)
from docspec.docpipeline.rkaf_projection import (  # noqa: E402
    ProjectionError,
    ProjectionSettings,
    project_document,
)
...
def _open_legacy_candidate_source(
    ...
    *,
    ...
    from docspec.enrichment.managed_release import (
...
def build_model(provider: str, model_id: str | None, *, compat_provider: str = "") -> Any:
    ...
    if provider == "anthropic":
        from docspec.docpipeline.adapters.anthropic import AnthropicStructuredTextModel
    ...
    if provider == "openai-compatible":
        from docspec.docpipeline.adapters.openai_compatible import (
