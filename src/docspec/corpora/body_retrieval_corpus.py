...
def _seal_lock(cache_dir: Path, manifest: Mapping[str, Any], *, rendition: str = "html") -> dict[str, Any]:
    ...
    from docspec.corpora.segmentation_evaluation import FORMAT_VERSION, _spec_digest
...
def write_v3_selection(
    ...
    *,
    ...
    from docspec.corpora.segmentation_evaluation import validate_source_cache
...
def measure_corpus(
    ...
    *,
    ...
    from docspec.docpipeline.source import native_structural_passage_spans
