...
from docspec.docpipeline.adapters.docling import (
...
from docspec.docpipeline.runtime import (
    CheckResult,
    redact,
    redact_text,
    scan_text_for_secrets,
)
from docspec.ontology.citations import normalize_regsgov_identifier
from docspec.ontology.common import canonical_json, iter_parquet_rows, stable_id, text_digest
from docspec.source_profiles import (
    EXCLUDED_SOURCE_TABLES as EXCLUDED_SOURCE_TABLES,
    PUBLIC_RECORD_ACCESS as PUBLIC_RECORD_ACCESS,
    REGION_ADAPTER_IDS as REGION_ADAPTER_IDS,
    REGION_ADAPTER_VERSION as REGION_ADAPTER_VERSION,
    SOURCE_PROFILES,
    SOURCE_PROFILE_BY_TABLE,
    STEP4_ACTIVE_SOURCE_TABLES as STEP4_ACTIVE_SOURCE_TABLES,
    UNDECLARED_ACCESS as UNDECLARED_ACCESS,
    AccessScope,
    SourceMode,
    SourceProfile,
)
...
_PROFILE_BY_TABLE = SOURCE_PROFILE_BY_TABLE
...
RETENTION_FLOORS: dict[str, RetentionFloor] = {
    ...
    "pymupdf:application/pdf": RetentionFloor(
        ...
        population="the same 18 segmentation-cache PDFs, re-measured through docspec.transforms.pdf_text_pymupdf",
    ),
}
...
WORKER_MODULE = "docspec.docpipeline.adapters.docling"
