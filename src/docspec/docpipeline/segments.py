...
What goes in is one :class:`~docspec.docpipeline.source.SourceArtifact` and
...
* **The processing stream is not re-decided here.**
  :func:`~docspec.docpipeline.source.processing_regions` is the whole input,
...
* **Coordinates are Python unicode codepoints, half-open**, and every slice
  carries its own :class:`~docspec.docpipeline.source.CoordinateSystem` saying
...
from docspec.docpipeline.runtime import CheckResult
...
from docspec.ontology.common import canonical_json, stable_id, text_digest
