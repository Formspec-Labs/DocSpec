...
from docspec.adapters.spicyregs import expected_schemas
...
from docspec.ontology.common import canonical_json, iter_parquet_rows
from docspec.ontology.concepts import latest_assignments
from docspec.ontology.ledger import (
    FINAL_STATUSES,
    KNOWN_STATUSES,
    SEGMENT_LEDGER_COLUMNS,
)
from docspec.ontology.llm import SUPPORTED_REASONING_EFFORTS
from docspec.ontology.subjects import (
    PROFILE_SEGMENTATION_POLICIES,
    iter_artifacts,
    segment_artifact,
)
from docspec.pipelines.ontology_dataset import OntologyDatasetPipeline
from docspec.transforms.build_proceedings import (
    STAGES,
...
def build_receipt(
    ...
    *,
    ...
    receipt = {
        ...
        "repositories": {
            "docspec": {**spicy_git, "after_gates": spicy_git_after},
