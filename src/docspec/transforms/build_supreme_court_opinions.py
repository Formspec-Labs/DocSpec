...
from docspec.sources.supreme_court_opinions import (
    SupremeCourtOpinionsReader,
)
from docspec.adapters.spicyregs import extract_pdf_text
...
def build_supreme_court_opinions(
    ...
    *,
    ...
    have_prior = prior_file.exists() or store.fetch(OUTPUT, prior_file)
    prior_rows = (
