...
A **new parser**, deliberately not an edit of :mod:`docspec.transforms.pdf_text`.
...
from docspec.adapters.spicyregs import PAGE_SEPARATOR, PdfTextResult, PdfTextStatus
