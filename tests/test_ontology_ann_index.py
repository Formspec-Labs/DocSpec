...
from docspec.ontology import ann_index as ann_module
from docspec.ontology.ann_index import (
...
from docspec.ontology.candidate_channels import DenseConceptIndex
