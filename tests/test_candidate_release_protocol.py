...
from docspec.docpipeline.rkaf_projection import candidate_release_vocabulary
...
def reject_refspec(name, *args, **kwargs):
    ...
    return original_import(name, *args, **kwargs)
builtins.__import__ = reject_refspec
import docspec.enrichment as enrichment
from docspec.enrichment.experiment_artifacts import DEVELOPMENT_DECISIONS
