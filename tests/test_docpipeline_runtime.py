...
from docspec.docpipeline import runtime
...
def test_runtime_imports_no_pipeline_step_provider_or_replaced_runner() -> None:
    ...
    assert {module for module in modules if module.startswith("docspec")} == {"docspec.ontology.common"}
