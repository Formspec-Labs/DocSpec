...
from docspec.adapters.spicyregs import PdfTextStatus
from docspec.adapters.spicyregs import extract_pdf_text as extract_with_pypdf
from docspec.transforms.pdf_text_pymupdf import (
...
class TestProvenanceIsWhatPypdfCannotGive:
    ...
    def test_word_boxes_are_available_and_land_on_the_page(self) -> None:
        from docspec.transforms.pdf_text_pymupdf import extract_pdf_word_boxes
...
class TestAdoptingItMovesNothingAlreadySealed:
    ...
    def test_the_named_parser_decides_not_the_default(self) -> None:
        from docspec.document_file_pipeline import (
    ...
    def test_the_new_default_is_the_new_parser(self) -> None:
        from docspec.document_file_pipeline import DEFAULT_PDF_EXTRACTION_METHOD, _extract_pdf_with
    ...
    def test_an_unknown_parser_fails_closed_instead_of_falling_back(self) -> None:
        ...
        from docspec.document_file_pipeline import DocumentFilePipelineError, _extract_pdf_with
    ...
    def test_each_parser_declares_its_own_retention_floor(self) -> None:
        from docspec.docpipeline.source import retention_floor_for
    ...
    def test_the_receipt_config_distinguishes_the_parsers(self) -> None:
        from docspec.document_file_pipeline import _pdf_extraction_config
