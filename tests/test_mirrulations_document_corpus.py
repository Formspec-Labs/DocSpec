...
from docspec.corpora import mirrulations_document_corpus as corpus
...
def test_three_split_ledgers_are_disjoint_complete_and_reference_cached_html(tmp_path: Path) -> None:
    ...
    from docspec.document_release_v3_writer import BuildConfig, build_release_from_partition_jsonl
