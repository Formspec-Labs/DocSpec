...
import pytest
import docspec.document_file_pipeline as file_pipeline_module
...
from docspec.adapters.spicyregs import PdfTextResult, PdfTextStatus
...
def test_local_real_file_corpus_is_addressable_across_every_source_family() -> None:
    from docspec.corpora.segmentation_evaluation import FULL_DOCUMENT_SPECS
