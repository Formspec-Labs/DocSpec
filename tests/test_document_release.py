...
import pytest
import docspec.document_release as document_release_module
...
def test_migration_manifest_accounts_for_serving_and_incubated_surfaces_without_retiring_them() -> None:
    ...
    for required_surface in (
        "src/docspec/cli.py",
        "src/docspec/transforms/build_search_index.py",
        ".github/workflows/rollup-docket-search.yml",
        "src/docspec/vectordb/embed.py",
        "notebooks/search_capabilities.ipynb",
        "notebooks/vector_search.ipynb",
        "src/docspec/mcp_server.py",
        "src/docspec/docpipeline/source.py",
        "src/docspec/docpipeline/segments.py",
        "src/docspec/docpipeline/retrieval.py",
        "src/docspec/ontology/vocabulary_atlas",
        "src/docspec/enrichment/",
        "tools/graphdb/",
        "RefSpec/",
